                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive table-hover">
                	...
                	<thead>
                		...
                		<tr>
                    		...
                    		<th style="padding: 5px;"><div><?php echo ('Patient Name');?></div></th>

                    		<th style="padding: 5px;"><div><?php echo ('Age');?></div></th>

                    		<th style="padding: 5px;"><div><?php echo ('Sex');?></div></th>

                    		<th style="padding: 5px;"><div><?php echo ('Blood Group');?></div></th>

                    		<th style="padding: 5px;"><div><?php echo ('Birth Date');?></div></th>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>index.php?admin/manage_patient/edit/<?php echo $row['patient_id'];?>"
                                	...
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit');?>" class="btn btn-success ">
                ...
                <div class="box-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>index.php?" class="form-horizontal validatable">
                        ...
                        <div class="form-actions" style="text-align: center;">
                            ...
                            <button type="submit" class="btn btn-primary"><?php echo ('Add Patient');?></button>
