                        ...
                        foreach ($departments as $row) : ?>
                            <tr>
                                ...
                                <td align="center" style="display:flex;">
                                    <a href="<?php echo base_url(); ?>index.php?admin/manage_department/edit/<?php echo $row['department_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-success">
                ...
                <div class="box-content">
                    ...
                    <div class="padded" style="text-align: center;">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo ('<b>Department Description  </b>'); ?> &nbsp;
                                <input type="text" class="center-input" name="description" />
                            </div>
                        </div>
                    </div>
                    <div class="form-actions" style="text-align: center;">
                        <button type="submit" class="btn btn-info"><?php echo ('Add Department'); ?></button>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
