                    ...
                    <tbody>
                        ...
                        foreach ($doctors as $row) : ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo base_url(); ?>index.php?admin/manage_doctor/edit/<?php echo $row['doctor_id']; ?>" rel="tooltip" data-placement="top" data-original-title="<?php echo ('Edit'); ?>" class="btn btn-success">
