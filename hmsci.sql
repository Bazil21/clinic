...
INSERT INTO `services` (`id`, `service_name`, `service_des`, `created_date`) VALUES
(2, 'PRIMARY CARE', 'We offer extensive medical services for our patients recommend that you use officia.simply dummy text of theprinting and typesetting industry medical officia.simply dummy text of theprinting and typesetting industry.', '2023-06-16 06:59:10'),
(3, 'FAMILY HEALTH CARE', 'Doctors Clinical team provides continuing and comprehensive health care for the individual and family across all ages, genders, diseases, and parts of the body.', '2023-06-16 07:00:59'),
(4, 'DIABETIC CLINIC', 'The Diabetic clinic provides total case management for diabetic individuals. We offer following services:\r\n\r\nComplete information, literature and management guidelines for patients\r\nDiagnosis & management of all types of Diabetes\r\nScreening of diabetes', '2023-06-16 07:01:36'),
(5, 'LAB SERVICES', 'Our intrinsic laboratory has the latest & state of the art equipment for most of the baseline tests.\r\n\r\nWe also have availability of a satellite lab for advanced lab tests which works in collaboration with the most well reputed labs of the city.\r\n\r\n', '2023-06-16 07:02:17');
